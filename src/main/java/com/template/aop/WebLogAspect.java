...
import com.template.util.IpUtils;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(* com.template.controller..*.*(..)) && !execution(* com.template.controller..*.getUserMapList(..))  || execution(* com.template.execption..*.*(..)) ")
